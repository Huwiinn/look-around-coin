...
export const globalCoinsInfoData: GlobalCoinsInfoDataItem[] = [
  ...
  { key: "btc_d", label: "비트코인 점유율", unit: "%" },
  { key: "eth_d", label: "이더리움 점유율", unit: "%" },
  { key: "mcap_change", label: "전일대비 시가총액 변화율", unit: "%" },
  { key: "volume_change", label: "전일대비 시장 거래량 변화율", unit: "%" },
  { key: "avg_change_percent", label: "전일대비 평균 변화율", unit: "%" },
